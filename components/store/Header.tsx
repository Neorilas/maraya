        ...
        <div className="flex items-center justify-between gap-2 sm:gap-3 py-1.5 sm:py-2 lg:py-3">
          ...
          >
            <Image
              ...
              height={420}
              priority
              sizes="(max-width: 640px) 48px, (max-width: 1024px) 72px, 88px"
              className="h-12 sm:h-16 lg:h-20 w-auto transition-transform group-hover:scale-105 drop-shadow-[0_2px_4px_rgba(244,114,182,0.25)]"
            />
          </Link>
